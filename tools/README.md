...
- 🧩 [**Agent template**](./agent-template/) — copy-pasteable one-page skeleton for the [portable agent workspace pattern](../guides/agent-workspaces/portable-agent-workspace-pattern.md).
...
- One subfolder per tool, kebab-case name (e.g. `copilot-cli/`).
- Each subfolder has a `README.md` summarizing the tool and linking to relevant
  tutorials and guides elsewhere in the repo.
